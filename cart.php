<section class="py-5">
    <div class="container">
        ...
        <div class="card rounded-0 cart-card">
            <div class="card-body">
                <h3><b>Cart List</b></h3>
                    ...
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div>
                                ...
                                <p class="mb-1 mb-sm-1"><small><b>Size:</b>
                                        <?php echo $row['size'] ?>
                                    </small></p>
                ...
                <?php endwhile; ?>
                <div class="d-flex w-100 justify-content-between mb-2 py-2 border-bottom align-bottom">
