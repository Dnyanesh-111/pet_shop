            ...
            <div class="container-fluid" id="printable">
                <table class="table table-bordered table-stripped" id="cstRptTbl">
                    ...
                    <tbody>
                        ...
                        if (isset($_POST['filter'])) {
                            ...
                            if ($filterValue == 'this_month') {
                                $query = "SELECT `firstname`,`lastname`,`gender`,`email`,`contact`,`date_created` FROM clients WHERE MONTH(date_created) = MONTH(CURRENT_DATE()) AND YEAR(date_created) = YEAR(CURRENT_DATE()) ORDER BY date_created DESC";
                                ...
                                $query = "SELECT `firstname`,`lastname`,`gender`,`email`,`contact`,`date_created` FROM clients ORDER BY date_created DESC";
                            }
                        } else {
                            $query = "SELECT `firstname`,`lastname`,`gender`,`email`,`contact`,`date_created` FROM clients ORDER BY date_created DESC";
                        }
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="7">
                                <?php echo "Total Customers: " . $qry->num_rows; ?>
                            </td>
                        </tr>
                    </tfoot>
                </table>
