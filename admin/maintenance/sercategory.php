...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="?page=maintenance/manage_sercategory" class="btn btn-flat btn-primary"><span
            ...
            <div class="container-fluid">
                <table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $qry = $conn->query("SELECT * from `services_category` order by unix_timestamp(date_created) desc ");
                                ...
                                <td align="center">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <a class="dropdown-item"
                                            href="?page=maintenance/manage_sercategory&id=<?php echo $row['id'] ?>"><span
...
<script>
    ...
    function delete_category($id) {
        start_loader();
        $.ajax({
            url: _base_url_ + "classes/Master.php?f=delete_scategory",
            method: "POST",
            data: { id: $id },
            dataType: "json",
            error: err => {
