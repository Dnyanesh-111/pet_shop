...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="?page=maintenance/manage_sub_category" class="btn btn-flat btn-primary"><span
            ...
            <div class="container-fluid">
                <table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $qry = $conn->query("SELECT s.*,c.category from `services_subcat` s inner join `services_category` c on c.id = s.parent_id order by unix_timestamp(s.date_created) desc ");
                                ...
                                <td align="center">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <a class="dropdown-item"
                                            href="?page=maintenance/manage_ser_sub_category&id=<?php echo $row['id'] ?>"><span
...
<script>
    ...
    function delete_category($id) {
        start_loader();
        $.ajax({
            url: _base_url_ + "classes/Master.php?f=delete_ssub_category",
            method: "POST",
            data: { id: $id },
            dataType: "json",
            error: err => {
