...
if (isset($_GET['id']) && $_GET['id'] > 0) {
    $qry = $conn->query("SELECT * from `services_subcat` where id = '{$_GET['id']}' ");
    if ($qry->num_rows > 0) {
...
<div class="card card-outline card-info">
    <div class="card-header">
        <h3 class="card-title">
            <?php echo isset($id) ? "Update " : "Create New " ?> Sub Catgory
        </h3>
    </div>
    <div class="card-body">
        <form action="" id="category-form">
            ...
            <div class="form-group">
                ...
                <select name="parent_id" id="parent_id" class="custom-select select2">
                    <option value=""></option>
                    <?php
                    $qry = $conn->query("SELECT * FROM `services_category` order by category asc");
            ...
            <div class="form-group">
                ...
                <textarea name="sub_category" id="" cols="30" rows="2"
                    class="form-control form no-resize"><?php echo isset($sub_category) ? $sub_category : ''; ?></textarea>
            </div>
            <div class="form-group">
    ...
    <div class="card-footer">
        ...
        <a class="btn btn-flat btn-default" href="?page=maintenance/ser_sub_category">Cancel</a>
    </div>
</div>
<script>
    ...
    $(document).ready(function () {
        ...
        $('#category-form').submit(function (e) {
            ...
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Master.php?f=save_sub_scategory",
                ...
                success: function (resp) {
                    if (typeof resp == 'object' && resp.status == 'success') {
                        location.href = "./?page=maintenance/ser_sub_category";
